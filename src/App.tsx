...
export default function App() {
  ...
  // Start music on first scroll if not already playing
  useEffect(() => {
    const handleScroll = () => {
      if (!hasStartedMusic && !isMusicPlaying) {
  ...
  }, [isMusicPlaying, hasStartedMusic]);
  ...
  return (
    ...
    >
      ...
      <div className="fixed opacity-0 pointer-events-none">
        <ReactPlayer
          url="https://www.youtube.com/watch?v=XhS1jk_9_9g"
